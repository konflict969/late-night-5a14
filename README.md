...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/late-night-5a14
```

A live public deployment of this template is available at [https://late-night-5a14.templates.workers.dev](https://late-night-5a14.templates.workers.dev)
